...
UpdateBusinessObjectHandler.prototype.execute = function(context) {
  ...
  var rootElements = getRoot(businessObject).rootElements
  var referenceType = context.referenceType
  var referenceProperty = context.referenceProperty
  var changed = [element] // this will not change any diagram-js elements
  ...
  var oldProperties = context.oldProperties || getProperties(businessObject, keys(properties))
